...
extension Anasayfa: UITableViewDelegate,UITableViewDataSource,HucreProtocol{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        hucre.hucreArkaplan.layer.cornerRadius = 25.0
        
        
        // seçim animasyonu iptal
        hucre.selectionStyle = .none
        
        // protocol için gerekenler ayarlanması
    ...
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let düzenleAction = UIContextualAction(style: .normal, title: "Düzenle"){contextualAction,view,bool in
